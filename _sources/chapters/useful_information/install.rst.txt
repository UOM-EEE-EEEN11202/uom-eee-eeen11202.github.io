...
Whichever method you pick, for the in-person exam you should be familiar with how to :ref:`run VSCode on a University computer. <codespaces>` Make sure you take the time to familiarise yourself with this, even if you do most of your coding on a personal device.
...
Our recommended approach is to use a :ref:`devcontainer on a personal device <devcontainer>` or a :ref:`codespace on a University cluster computer <codespaces>`.